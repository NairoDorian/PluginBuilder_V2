...
class CudaPOP : public POP_CPlusPlusBase
{
public:
	CudaPOP(const OP_NodeInfo *info, POP_Context *context);
	virtual ~CudaPOP();
...
private:
	void				copyAllAttributes(POP_AttributeClass c, std::vector<std::pair<std::string, OP_SmartRef<POP_Buffer>>>& attrs,
