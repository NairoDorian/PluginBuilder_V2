...
extern "C"
{
	...
	CreatePOPInstance(const OP_NodeInfo* info, POP_Context* context)
	{
		...
		return new SimpleShapesPOP(info, context);
	}
	...
	DestroyPOPInstance(POP_CPlusPlusBase* instance)
	{
		...
		delete (SimpleShapesPOP*)instance;
	}

};

SimpleShapesPOP::SimpleShapesPOP(const OP_NodeInfo* info, POP_Context* context) :
	myNodeInfo(info),
	myContext(context)
{
	myExecuteCount = 0;
...
SimpleShapesPOP::~SimpleShapesPOP()
{

}

void
SimpleShapesPOP::getGeneralInfo(POP_GeneralInfo* ginfo, const OP_Inputs* inputs, void* reserved)
{
...
SimpleShapesPOP::createBuffer(POP_BufferInfo createInfo)
{
...
OP_SmartRef<POP_Buffer>
SimpleShapesPOP::createTopologyInfoBuffer()
{
...
OP_SmartRef<POP_Buffer>
SimpleShapesPOP::createPointInfoBuffer()
{
	POP_BufferInfo createInfo;
...
OP_SmartRef<POP_Buffer>
SimpleShapesPOP::createGridInfoBuffer(uint32_t numDims)
{
	POP_BufferInfo createInfo;
...
void
SimpleShapesPOP::cubeGeometry(POP_Output* output, float scale)
{
...
void
SimpleShapesPOP::mixedPrimitives(POP_Output* output)
{
	POP_SetBufferInfo sinfo;
...
void
SimpleShapesPOP::mixedPrimitivesComplex(POP_Output* output)
{
	POP_SetBufferInfo sinfo;
...
void
SimpleShapesPOP::gridGeometry(POP_Output* output)
{
	POP_SetBufferInfo sinfo;
	POP_BufferInfo attBufCreateInfo;
...
void
SimpleShapesPOP::execute(POP_Output* output, const OP_Inputs* inputs, void* reserved)
{
	myExecuteCount++;
...
int32_t
SimpleShapesPOP::getNumInfoCHOPChans(void* reserved)
{
...
void
SimpleShapesPOP::getInfoCHOPChan(int32_t index, OP_InfoCHOPChan* chan, void* reserved)
{
...
bool
SimpleShapesPOP::getInfoDATSize(OP_InfoDATSize* infoSize, void* reserved)
{
	infoSize->rows = 3;
	infoSize->cols = 2;
...
void
SimpleShapesPOP::getInfoDATEntries(int32_t index,
								int32_t nEntries,
...
void
SimpleShapesPOP::setupParameters(OP_ParameterManager* manager, void* reserved)
{
	// scale
	{
